...
//FILTRO FECHAS
import json from '../../datos/datos_globales_grafo_hashtags_menciones.json'
...
.filter((fecha, index) => index > fechas.length - 4) 
.map((fecha, index) => (
...
// // FIN FILTRO FECHAS
  ...
  return (
    ...
    <a href={`https://qsngrafos.vercel.app/hasgtags-menciones/39761017-M/grafo_hashtags_menciones-${filtroFecha}.html`} target="_blank">
