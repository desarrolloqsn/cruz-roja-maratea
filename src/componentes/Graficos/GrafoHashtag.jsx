...
import json from './../../datos/datos_globales_grafo_co_ocurrencia_hashtags.json'
 ...
 const handleFiltroFechaChange = (valor) => {
  ...
  return (
   ...
   <Select placeholder="Fechas" className='fechas-grafos' onChange={handleFiltroFechaChange} defaultValue={filtroFecha}>
    ...
    <a href={`https://qsngrafos.vercel.app/co-ocurrencia/39761017-L/grafo_co-ocurencia_hashtags-${filtroFecha}.html`} target="_blank">
